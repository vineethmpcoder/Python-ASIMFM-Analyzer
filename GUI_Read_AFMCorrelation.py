...
#            print(x,y)
            ...
            for i in range(n0Sx.shape[0]):
                for j in range(n0Sx.shape[1]):
                    ...
                    if s!=0 and i-y >=0 and j-x >=0 and i+y <=n0Sx.shape[0]-2 and j+x <= n0Sx.shape[0]-2 :
                        ...
                        if((x+y)%2 != 0):
                            ...
                            Cijxy = (Clt + Clb + Crb + Crt)/4
####################################################################################################
                    if s!=0 and i-x >=0 and j-y >=0 and i+x <=n0Sx.shape[0]-2 and j+y <= n0Sx.shape[0]-2 :

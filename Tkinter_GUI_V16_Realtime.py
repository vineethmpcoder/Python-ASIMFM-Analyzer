...
###############################################################################        
        ...
        for X in range(0,Mm-1):
            for Y in range(0,Nn-1):
                ...
                if (n0Vb[Y,X] == 20 or n0Vb[Y,X] == 21 or n0Vb[Y,X] == 22 or n0Vb[Y,X] == 23):
                    blank_image.paste(T2B, (round(X*(l+w)+l), round(l + Y*(l+w))), mask = T2B)
                if (n0Vb[Y,X] == 30 or n0Vb[Y,X] == 31 or n0Vb[Y,X] == 32 or n0Vb[Y,X] == 33 or n0Vb[Y,X] == 34 or n0Vb[Y,X] == 35 or n0Vb[Y,X] == 36 or n0Vb[Y,X] == 37):
...
#        blank_image.show()
        scipy.misc.imsave(folder_path +'/'+folder_name+'_DI_vertex'+'.png', blank_image)
